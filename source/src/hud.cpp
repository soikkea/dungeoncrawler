...
void Hud::update(float elapsedTime, const Player& player)
{
	...
	playerInfo << "Moves: " << player.playerCreature.stats.at(StatEnum::MovementPoints).value << "/" << player.playerCreature.stats.at(StatEnum::MovementPoints).maxValue << std::endl;
